...
<form method="POST" action="">
 ...
 <div class="row">
	...
	<div style="text-align:center;" class="pt-4 pb-3">
		<button type="submit" name="register" id="reg" class="btn btn-outline-dark " style="text-align: center;  width: 120px; height:40px; background-color:white; color:black;">Register
		</button>
	</div>
</form>
</div> 
