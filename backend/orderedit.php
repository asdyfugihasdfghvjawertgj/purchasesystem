...
$ordercontrol->updateOrder($orderid,$item,$qty,$name,$pay,$voucher_id,$date);
                   ...
                   <div class="row my-2 ml-3">
                       <div class="col-md-12">
                           <div class='float-right' style="background-color: green;">
                               <a href='orderindex.php' class='btn btn-primary pull-right'>View All</a>
                           </div>
                       </div>
                       <div class="col-md-12 my-2 " >
                        ...
                        ?>     
                           ...
                           <div class="col-md-12">
                               KPay &nbsp;<input type="radio" name="payment" value="KPay">
                               Visa &nbsp;<input type="radio" name="payment" value="Visa">
                               AYA &nbsp;<input type="radio" name="payment" value="AYA">
                               WAVEPay &nbsp;<input type="radio" name="payment" value="WAVEPay">
                           </div>
