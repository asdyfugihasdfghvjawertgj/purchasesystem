...
$results=$ordercontrol->showVoucher();
?>
...
<div class='float-right' style="border-radius:20px; margin:0 0 10px 0">
    <a href='createvoucher.php' class='btn btn-primary pull-right'>Create Voucher</a>
</div>
...
<td><?php echo $result['deli'];?> </td>
<td><?php echo $result['commission'];?> </td>


<td><a class="btn btn-primary" href="voucherview.php?id=<?php echo $result['id'];?>" ><i class="fa fa-eye"></i></a>&nbsp; &nbsp; <a class="btn btn-success" href="voucheredit.php?id=<?php echo $result['id'];?>"><i class="fa fa-edit"></i></a>&nbsp; &nbsp; <a class="btn btn-danger" onclick="return deleteuser(<?php echo $result['id'];?>);"><i class="fa fa-trash"></i></a></td>
</tr>
...
<script type="text/javascript">
	function deleteuser(id){
		...
		if ($result) {
			window.location.href="voucherdelete.php?id="+id;
			return true;
		}
	}
</script>
